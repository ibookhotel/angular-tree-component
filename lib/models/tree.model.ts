...
const {
    first, last, compact, find, includes,
    remove, indexOf, pullAt, isString, isFunction
} = _;
...
export class TreeModel implements ITreeModel {
    ...
    @observable virtualRootFake: TreeNode;
    ...
    // actions
    @action
    setData({nodes, fakeNodes, options = null, events = null}: { nodes: any, fakeNodes: any, options: any, events: any }) {
        if (options) {
    ...
    update() {
        ...
        let virtualRootConfigFake = {
            virtual: true,
            [this.options.childrenField]: this.fakeNodes
        };

        this.virtualRoot = new TreeNode(virtualRootConfig, null, this, 0);
        this.virtualRootFake = new TreeNode(virtualRootConfigFake, null, this, 0);

        this.roots = this.virtualRoot.children;
        this.rootsFake = this.virtualRootFake.children;
